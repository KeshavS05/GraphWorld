...
class twoD_Render():
    ...
    def __init__(self, html, length, height, depth, G, agents, type_of_weighted, time_step) -> None:
        self.G = G
        self.html = html
        self.length = length
        self.height = height
    ...
    def render(self, image_size, grid_line_color, grid_tick_val, grid_line_type, default_edge_color, active_support_edge_color, inactive_support_edge_color, node_color, node_border_color, terminating_node_color, supporting_node_color, agent_color, agent_label_text_color): 
        if self.html:
            ...
            trace5=go.Scatter(x=bxE,
                        ...
                        line=dict(color=self.color_string(inactive_support_edge_color), width=2)
                        )
            ...
            x_axis=dict(showbackground=True,
                    ...
                    showticklabels=True,
                    autorange=False,
                    gridcolor='white',#self.rgb_to_hex(grid_line_color[0], grid_line_color[1], grid_line_color[2]),
                    color='#FFF',
                    tickmode="array",
                    range = [0, self.length],
